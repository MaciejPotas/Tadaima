...
{
    Word word1{ 1, "kana1", "translation1", "romaji1", "example1", {"tag1", "tag2"} };
    Word word2{ 1, "kana1", "translation1", "romaji1", "example1", {"tag1", "tag2"} };
    Word word3{ 2, "kana2", "translation2", "romaji2", "example2", {"tag3", "tag4"} };
...
{
    Word word1{ 1, "kana1", "translation1", "romaji1", "example1", {"tag1", "tag2"} };
    Word word2{ 2, "kana2", "translation2", "romaji2", "example2", {"tag3", "tag4"} };

    Lesson lesson1{ 1, "mainName1", "subName1", {word1, word2} };
    Lesson lesson2{ 1, "mainName1", "subName1", {word1, word2} };
    Lesson lesson3{ 2, "mainName2", "subName2", {word2} };
...
TEST(LessonTest, IsEmpty)
{
    ...
    Lesson nonEmptyLesson{ 1, "mainName1", "subName1", {Word{1, "kana1", "translation1", "romaji1", "example1", {"tag1"}}} };
